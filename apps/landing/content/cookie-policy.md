...
When you first visit ScanOrbit, you'll see a simple consent banner:

```
🍪 We use cookies for authentication and your preferences.
[Accept Cookies]  [Cookie Policy]
```

- **Accept Cookies** - Stores all cookies
- **Cookie Policy** - Read this page
- **No "Reject" button needed** - Essential cookies don't require opt-in under GDPR
