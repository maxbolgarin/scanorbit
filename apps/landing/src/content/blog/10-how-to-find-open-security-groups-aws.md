...
[ScanOrbit](https://scanorbit.cloud) detects permissive security groups across all your AWS regions and accounts automatically — no scripts, no region-switching. Run a scan and get a complete report in minutes.
...
[ScanOrbit](https://scanorbit.cloud) detects permissive security groups across all regions automatically. Run a scan and see what's exposed in your account right now.
