...
// GET /orgs/:id/audit-logs - List audit logs for organization
...
// POST /orgs/:id/invitations — Create invitation (admin)
...
// GET /orgs/:id/seats — Get organization member counts
...
// POST /orgs/:id/api-keys — Create API key (admin)
...
// GET /orgs/:id/api-keys — List API keys (any member)
...
// DELETE /orgs/:id/api-keys/:keyId — Revoke API key (admin)
