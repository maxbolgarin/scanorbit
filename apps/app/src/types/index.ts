...
export interface MeResponse {
  ...
  orgs: Org[];
  /**
   * Whether the backend has authentication turned on.
   *  - true  → full multi-user mode (login, signup, OAuth, 2FA available)
   *  - false → single-user mode: every request is the built-in admin and the
