...
import { ALL_SCANNER_TYPES } from "@/types";
import type { AwsAccount } from "@/types";
import { formatRelativeTime, formatDateTime } from "@/lib/utils";
import { Cloud, Plus, LayoutDashboard, History, ScanLine, Settings2, AlertTriangle, Copy, Check } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export default function Accounts() {
  ...
  const { currentAccountId, clearAccountContext } = useAccountContextStore();
