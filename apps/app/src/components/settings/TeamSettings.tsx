...
import { Users, UserPlus, Trash2, Mail, RotateCcw } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      {seatInfo && (
        <Alert>
          ...
          <AlertDescription>
            <strong>{seatInfo.totalMembers}</strong> member{seatInfo.totalMembers !== 1 ? "s" : ""}
            {seatInfo.pendingInvitations > 0 && (
              <>, <strong>{seatInfo.pendingInvitations}</strong> pending invitation{seatInfo.pendingInvitations !== 1 ? "s" : ""}</>
            )}
            .
          </AlertDescription>
        </Alert>
