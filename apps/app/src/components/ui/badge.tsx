  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-bold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-success/25 text-neon-green",
        warning:
          "border-transparent bg-warning/25 text-warning-orange",
        error:
          "border-transparent bg-destructive/25 text-alert-red",
      },
    },
    defaultVariants: {
      variant: "default",
