...
const serviceColors: Record<ServiceType, string> = {
  ec2: "text-status-high",
  ebs: "text-status-info",
  eip: "text-pink-500",
  rds: "text-purple-500",
  rds_snapshot: "text-purple-400",
  s3: "text-status-success",
  alb: "text-cyan-500",
  acm: "text-status-warning",
  lambda: "text-status-warning",
  cloudwatch_logs: "text-teal-500",
  cloudwatch_alarm: "text-status-critical",
