# ScanOrbit Pricing Tiers – Copy You Can Use
...
✓ **API access** (automate scans in CI/CD)  
✓ **Scan priority** (faster execution in busy moments)  
...
## **FAQ Blurbs** (copy to address common questions)
...
### *What's the API for?*
```
The Pro API lets you trigger scans programmatically, fetch findings in real-time, 
and integrate ScanOrbit into your automation workflows (CI/CD, Terraform, CloudFormation, etc.).
```

### *What's "scan priority" mean?*
```
When our systems are busy, Pro users' scans are executed first. This ensures 
your security scans complete quickly even during peak usage times.
```

### *Can I cancel anytime?*
```
Yes. Cancel in your account settings anytime. No cancellation fees. Your data 
is deleted immediately upon cancellation.
```

### *Do you offer annual billing discounts?*
```
Not yet—we'll be adding annual plans once we hit product-market fit. For now, 
...
```
"We found €2,400/month in orphaned resources ScanOrbit caught in the first week."
...
6. **FAQ section** should live below pricing (people often scroll past pricing to FAQs to check terms).

---

## **One-Liner for Your Landing Hero**
