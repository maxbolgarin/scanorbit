...
> **Note:** Finding types marked with **(Planned)** are defined in the system but not yet actively generated by analyzers. They are included here as the target specification for future implementation.
...
#### `publicly_accessible_rds` **(Planned)**
**Severity:** CRITICAL
...
#### `overly_permissive_policy` **(Planned)**
**Severity:** HIGH
...
#### `vpc_flow_logs_disabled` **(Planned)**
**Severity:** MEDIUM
